...
export default function TermosDeUsoPage() {
  ...
  useEffect(() => {
    // Verificar se precisa mostrar botões de aceitação
    const needsAcceptance = new URLSearchParams(window.location.search).get('accept') === 'true';
    setShowAcceptButtons(needsAcceptance);
  }, []);
